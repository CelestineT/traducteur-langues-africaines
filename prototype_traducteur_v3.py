...
===============================================
Version finale avec couleurs personnalisées
...
<div class="custom-header">
    <div class="header-content">
        ...
        <p class="header-subtitle">Prototype MVP · Eton, Bamoun, Fulfulde, Douala · avec audios authentiques</p>
    </div>
...
st.markdown('<p style="text-align: center; color: #999; margin-top: 2rem;">Prototype MVP – Données limitées</p>', unsafe_allow_html=True)
